# acmt.002.001.08-physical
```mermaid
classDiagram
    class ISO20022.Acmt002001.Document {
        # Uri  : String
        + AcctDtlsConf () : ISO20022.Acmt002001.DocumentAcctDtlsConf
        + Validation () = validation(validElement(AcctDtlsConf))
    }
...
## EntityImpl ISO20022.Acmt002001.Document


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|#|Uri|String||XmlIgnore(), JsonIgnore()||
|+|AcctDtlsConf|ISO20022.Acmt002001.DocumentAcctDtlsConf||XmlElement()||
