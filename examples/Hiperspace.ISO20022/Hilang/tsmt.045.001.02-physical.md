# tsmt.045.001.02-physical
```mermaid
classDiagram
    class ISO20022.Tsmt045001.Document {
        # Uri  : String
        + FwdInttToPayNtfctn () : ISO20022.Tsmt045001.ForwardIntentToPayNotificationV02
        + Validation () = validation(validElement(FwdInttToPayNtfctn))
    }
    class ISO20022.Tsmt045001.ForwardIntentToPayNotificationV02 {
        # owner  : ISO20022.Tsmt045001.Document
        ...
        + UsrTxRef  : List~ISO20022.Tsmt045001.DocumentIdentification5~
        ...
        + Validation () = validation(validElement(ReqForActn),validElement(InttToPay),validElement(SellrBk),validElement(BuyrBk),validList("""UsrTxRef""",UsrTxRef),validListMax("""UsrTxRef""",UsrTxRef,2),validElement(UsrTxRef),validElement(TxSts),validElement(EstblishdBaselnId),validElement(TxId),validElement(NtfctnId))
    }
```
...
## EntityImpl ISO20022.Tsmt045001.Document
...
## AspectImpl ISO20022.Tsmt045001.ForwardIntentToPayNotificationV02
...
|+|UsrTxRef|List<ISO20022.Tsmt045001.DocumentIdentification5>||XmlElement()||
