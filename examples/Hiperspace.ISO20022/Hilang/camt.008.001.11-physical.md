# camt.008.001.11-physical
```mermaid
classDiagram
    class ISO20022.Camt008001.Document {
        # Uri  : String
        + CclTx () : ISO20022.Camt008001.CancelTransactionV11
        + Validation () = validation(validElement(CclTx))
    }
    class ISO20022.Camt008001.CancelTransactionV11 {
        # owner  : ISO20022.Camt008001.Document
        + SplmtryData  : List~ISO20022.Camt008001.SupplementaryData1~
        ...
        + Validation () = validation(validList("""SplmtryData""",SplmtryData),validElement(SplmtryData),validElement(CxlRsn),validElement(CshAcct),validElement(PmtId),validElement(MsgHdr))
    }
```
...
## EntityImpl ISO20022.Camt008001.Document
...
## AspectImpl ISO20022.Camt008001.CancelTransactionV11


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|#|owner|ISO20022.Camt008001.Document||||
|+|SplmtryData|List<ISO20022.Camt008001.SupplementaryData1>||XmlElement()||
