# colr.015.001.05-physical
```mermaid
classDiagram
    class ISO20022.Colr015001.Document {
        # Uri  : String
        + IntrstPmtStmt () : ISO20022.Colr015001.InterestPaymentStatementV05
        + Validation () = validation(validElement(IntrstPmtStmt))
    }
    class ISO20022.Colr015001.InterestPaymentStatementV05 {
        # owner  : ISO20022.Colr015001.Document
        + SplmtryData  : List~ISO20022.Colr015001.SupplementaryData1~
        ...
        + TxId  : String
        + Validation () = validation(validList("""SplmtryData""",SplmtryData),validElement(SplmtryData),validElement(IntrstStmt),validElement(Pgntn),validElement(StmtParams),validElement(Oblgtn),validElement(Agrmt))
    }
```
...
## EntityImpl ISO20022.Colr015001.Document
...
## AspectImpl ISO20022.Colr015001.InterestPaymentStatementV05


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|#|owner|ISO20022.Colr015001.Document||||
|+|SplmtryData|List<ISO20022.Colr015001.SupplementaryData1>||XmlElement()||
