# camt.017.001.05-physical
```mermaid
classDiagram
    class ISO20022.Camt017001.Document {
        # Uri  : String
        + RtrCcyXchgRate () : ISO20022.Camt017001.ReturnCurrencyExchangeRateV05
        + Validation () = validation(validElement(RtrCcyXchgRate))
    }
    class ISO20022.Camt017001.ReturnCurrencyExchangeRateV05 {
        # owner  : ISO20022.Camt017001.Document
        + SplmtryData  : List~ISO20022.Camt017001.SupplementaryData1~
...
## EntityImpl ISO20022.Camt017001.Document
...
## AspectImpl ISO20022.Camt017001.ReturnCurrencyExchangeRateV05


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|#|owner|ISO20022.Camt017001.Document||||
|+|SplmtryData|List<ISO20022.Camt017001.SupplementaryData1>||XmlElement()||
