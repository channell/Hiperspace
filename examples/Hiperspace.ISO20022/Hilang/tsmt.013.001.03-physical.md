# tsmt.013.001.03-physical
```mermaid
classDiagram
    class ISO20022.Tsmt013001.Document {
        # Uri  : String
        + DataSetMtchRpt () : ISO20022.Tsmt013001.DataSetMatchReportV03
        + Validation () = validation(validElement(DataSetMtchRpt))
    }
    class ISO20022.Tsmt013001.DataSetMatchReportV03 {
        # owner  : ISO20022.Tsmt013001.Document
        ...
        + CmpardDocRef  : List~ISO20022.Tsmt013001.DocumentIdentification10~
        ...
        + UsrTxRef  : List~ISO20022.Tsmt013001.DocumentIdentification5~
...
## EntityImpl ISO20022.Tsmt013001.Document
...
## AspectImpl ISO20022.Tsmt013001.DataSetMatchReportV03
...
|+|CmpardDocRef|List<ISO20022.Tsmt013001.DocumentIdentification10>||XmlElement()||
...
|+|UsrTxRef|List<ISO20022.Tsmt013001.DocumentIdentification5>||XmlElement()||
