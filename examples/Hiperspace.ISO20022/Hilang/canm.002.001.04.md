...
classDiagram
    ...
    class ISO20022.Canm002001.AdditionalData1 {
        + Val  : String
        + Tp  : String
    }
    class ISO20022.Canm002001.AdditionalData2 {
        + Dtls  : global::System.Collections.Generic.List~ISO20022.Canm002001.AdditionalData1~
        + Tp  : String
    }
    ISO20022.Canm002001.AdditionalData2 *-- ISO20022.Canm002001.AdditionalData1
    class ISO20022.Canm002001.AdditionalFee3 {
        + Desc  : String
        + OthrAssgnr  : String
        + Assgnr  : String
    ...
    class ISO20022.Canm002001.BatchManagementInformation1 {
        + MsgChcksmInptVal  : String
        + MsgSeqNb  : String
        + BtchId  : String
        + ColltnId  : String
    }
    class ISO20022.Canm002001.ContentInformationType41 {
        + MAC  : String
        + MACData  : ISO20022.Canm002001.MACData1
    }
    ISO20022.Canm002001.ContentInformationType41 *-- ISO20022.Canm002001.MACData1
    class ISO20022.Canm002001.CreditDebit3Code {
        DBIT = 1
        CRDT = 2
    }
    class ISO20022.Canm002001.ErrorDetails3 {
    ...
    class ISO20022.Canm002001.GenericIdentification183 {
        + ShrtNm  : String
        + Ctry  : String
        + Assgnr  : String
        + OthrTp  : String
    ...
    class ISO20022.Canm002001.Header71 {
        + Tracblt  : global::System.Collections.Generic.List~ISO20022.Canm002001.Traceability10~
        + TracData  : global::System.Collections.Generic.List~ISO20022.Canm002001.AdditionalData1~
        + RcptPty  : ISO20022.Canm002001.GenericIdentification183
        + InitgPty  : ISO20022.Canm002001.GenericIdentification183
        + BtchMgmtInf  : ISO20022.Canm002001.BatchManagementInformation1
        + CreDtTm  : DateTime
    ...
    ISO20022.Canm002001.Header71 *-- ISO20022.Canm002001.Traceability10
    ISO20022.Canm002001.Header71 *-- ISO20022.Canm002001.AdditionalData1
    ISO20022.Canm002001.Header71 *-- ISO20022.Canm002001.GenericIdentification183
    ISO20022.Canm002001.Header71 *-- ISO20022.Canm002001.GenericIdentification183
    ISO20022.Canm002001.Header71 *-- ISO20022.Canm002001.BatchManagementInformation1
    class ISO20022.Canm002001.Jurisdiction2 {
        + DmstQlfctn  : String
        + DmstInd  : String
    }
    class ISO20022.Canm002001.MACData1 {
        + InitlstnVctr  : String
        + PddgMtd  : String
        + KeyIndx  : String
        + KeyPrtcn  : String
    ...
    class ISO20022.Canm002001.MessageError1Code {
        ICOL = 1
        IBAT = 2
        IDRM = 3
        IDWM = 4
    ...
    class ISO20022.Canm002001.NetworkManagementResponseV04 {
        ...
        + SplmtryData  : global::System.Collections.Generic.List~ISO20022.Canm002001.SupplementaryData1~
        + OrgnlRspnCd  : String
        + PrcgRslt  : ISO20022.Canm002001.ProcessingResult23
        + AddtlData  : global::System.Collections.Generic.List~ISO20022.Canm002001.AdditionalData2~
        + TxDesc  : String
        + Rcncltn  : ISO20022.Canm002001.Reconciliation4
        + AddtlFee  : global::System.Collections.Generic.List~ISO20022.Canm002001.AdditionalFee3~
    ...
    ISO20022.Canm002001.NetworkManagementResponseV04 *-- ISO20022.Canm002001.ContentInformationType41
    ISO20022.Canm002001.NetworkManagementResponseV04 *-- ISO20022.Canm002001.SupplementaryData1
    ISO20022.Canm002001.NetworkManagementResponseV04 *-- ISO20022.Canm002001.ProcessingResult23
    ISO20022.Canm002001.NetworkManagementResponseV04 *-- ISO20022.Canm002001.AdditionalData2
    ISO20022.Canm002001.NetworkManagementResponseV04 *-- ISO20022.Canm002001.Reconciliation4
    ISO20022.Canm002001.NetworkManagementResponseV04 *-- ISO20022.Canm002001.AdditionalFee3
    ISO20022.Canm002001.NetworkManagementResponseV04 *-- ISO20022.Canm002001.SettlementService6
    ISO20022.Canm002001.NetworkManagementResponseV04 *-- ISO20022.Canm002001.Jurisdiction2
    ISO20022.Canm002001.NetworkManagementResponseV04 *-- ISO20022.Canm002001.ProgrammeMode5
    ISO20022.Canm002001.NetworkManagementResponseV04 *-- ISO20022.Canm002001.Header71
    class ISO20022.Canm002001.NetworkManagementType1Code {
        ERBI = 1
        DRBI = 2
        SYCL = 3
        IART = 4
    ...
    class ISO20022.Canm002001.PartyType17Code {
        AGNT = 1
        CISP = 2
        CISS = 3
        ACQP = 4
    ...
    class ISO20022.Canm002001.PartyType18Code {
        AGNT = 1
        CSCH = 2
        CISS = 3
        ACQR = 4
    }
    class ISO20022.Canm002001.PartyType26Code {
        OTHP = 1
        OTHN = 2
        AGNT = 3
        DLIS = 4
    ...
    class ISO20022.Canm002001.PartyType32Code {
        OTHP = 1
        OTHN = 2
        ISUR = 3
        AGNT = 4
    ...
    class ISO20022.Canm002001.PartyType9Code {
        SCHP = 1
        CSCH = 2
        CISP = 3
        CISS = 4
    ...
    class ISO20022.Canm002001.ProcessingResult23 {
        + AddtlInf  : global::System.Collections.Generic.List~ISO20022.Canm002001.AdditionalData1~
        + ErrDtl  : global::System.Collections.Generic.List~ISO20022.Canm002001.ErrorDetails3~
        + RspnCd  : String
    ...
    ISO20022.Canm002001.ProcessingResult23 *-- ISO20022.Canm002001.AdditionalData1
    ISO20022.Canm002001.ProcessingResult23 *-- ISO20022.Canm002001.ErrorDetails3
    class ISO20022.Canm002001.ProgrammeMode5 {
        + AddtlId  : global::System.Collections.Generic.List~ISO20022.Canm002001.AdditionalData1~
        + ApldId  : String
    }
    ISO20022.Canm002001.ProgrammeMode5 *-- ISO20022.Canm002001.AdditionalData1
    class ISO20022.Canm002001.Reconciliation4 {
        + ChckptRef  : String
        + Dt  : DateTime
        + Id  : String
    }
    class ISO20022.Canm002001.SettlementService6 {
        + AddtlInf  : global::System.Collections.Generic.List~ISO20022.Canm002001.AdditionalData1~
        + RptgNttyId  : String
        + RptgNttyTp  : String
        + CutOffTm  : DateTime
    ...
    ISO20022.Canm002001.SettlementService6 *-- ISO20022.Canm002001.AdditionalData1
    class ISO20022.Canm002001.SupplementaryData1 {
        + Envlp  : ISO20022.Canm002001.SupplementaryDataEnvelope1
        + PlcAndNm  : String
    }
    ISO20022.Canm002001.SupplementaryData1 *-- ISO20022.Canm002001.SupplementaryDataEnvelope1
    class ISO20022.Canm002001.SupplementaryDataEnvelope1 {
    }
    class ISO20022.Canm002001.Traceability10 {
        + DtTmOut  : DateTime
        + DtTmIn  : DateTime
        + ShrtNm  : String
        + Ctry  : String
    ...
    class ISO20022.Canm002001.TypeOfAmount21Code {
        MNIF = 1
        MXIF = 2
        CSIF = 3
        FEEA = 4
...
## Value ISO20022.Canm002001.AdditionalData1
...
## Value ISO20022.Canm002001.AdditionalData2


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|+|Dtls|global::System.Collections.Generic.List<ISO20022.Canm002001.AdditionalData1>||XmlElement()||
|+|Tp|String||XmlElement()||
||Validation|Some(String)||XmlIgnore(), JsonIgnore()|validation(validList("""Dtls""",Dtls),validElement(Dtls))|

---

## Value ISO20022.Canm002001.AdditionalFee3
...
## Value ISO20022.Canm002001.BatchManagementInformation1
...
## Value ISO20022.Canm002001.ContentInformationType41


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|+|MAC|String||XmlElement()||
|+|MACData|ISO20022.Canm002001.MACData1||XmlElement()||
||Validation|Some(String)||XmlIgnore(), JsonIgnore()|validation(validPattern("""MAC""",MAC,"""([0-9A-F][0-9A-F]){1,8}"""),validElement(MACData))|

---

## Enum ISO20022.Canm002001.CreditDebit3Code
...
## Type ISO20022.Canm002001.Document
...
## Value ISO20022.Canm002001.ErrorDetails3
...
## Value ISO20022.Canm002001.GenericIdentification183
...
## Value ISO20022.Canm002001.Header71


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|+|Tracblt|global::System.Collections.Generic.List<ISO20022.Canm002001.Traceability10>||XmlElement()||
|+|TracData|global::System.Collections.Generic.List<ISO20022.Canm002001.AdditionalData1>||XmlElement()||
|+|RcptPty|ISO20022.Canm002001.GenericIdentification183||XmlElement()||
|+|InitgPty|ISO20022.Canm002001.GenericIdentification183||XmlElement()||
|+|BtchMgmtInf|ISO20022.Canm002001.BatchManagementInformation1||XmlElement()||
...
## Value ISO20022.Canm002001.Jurisdiction2
...
## Value ISO20022.Canm002001.MACData1
...
## Enum ISO20022.Canm002001.MessageError1Code
...
## Aspect ISO20022.Canm002001.NetworkManagementResponseV04


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|+|SctyTrlr|ISO20022.Canm002001.ContentInformationType41||XmlElement()||
|+|SplmtryData|global::System.Collections.Generic.List<ISO20022.Canm002001.SupplementaryData1>||XmlElement()||
|+|OrgnlRspnCd|String||XmlElement()||
|+|PrcgRslt|ISO20022.Canm002001.ProcessingResult23||XmlElement()||
|+|AddtlData|global::System.Collections.Generic.List<ISO20022.Canm002001.AdditionalData2>||XmlElement()||
|+|TxDesc|String||XmlElement()||
|+|Rcncltn|ISO20022.Canm002001.Reconciliation4||XmlElement()||
|+|AddtlFee|global::System.Collections.Generic.List<ISO20022.Canm002001.AdditionalFee3>||XmlElement()||
...
## Enum ISO20022.Canm002001.NetworkManagementType1Code
...
## Enum ISO20022.Canm002001.PartyType17Code
...
## Enum ISO20022.Canm002001.PartyType18Code
...
## Enum ISO20022.Canm002001.PartyType26Code
...
## Enum ISO20022.Canm002001.PartyType32Code
...
## Enum ISO20022.Canm002001.PartyType9Code
...
## Value ISO20022.Canm002001.ProcessingResult23


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|+|AddtlInf|global::System.Collections.Generic.List<ISO20022.Canm002001.AdditionalData1>||XmlElement()||
|+|ErrDtl|global::System.Collections.Generic.List<ISO20022.Canm002001.ErrorDetails3>||XmlElement()||
...
## Value ISO20022.Canm002001.ProgrammeMode5


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|+|AddtlId|global::System.Collections.Generic.List<ISO20022.Canm002001.AdditionalData1>||XmlElement()||
...
## Value ISO20022.Canm002001.Reconciliation4
...
## Value ISO20022.Canm002001.SettlementService6
...
## Value ISO20022.Canm002001.SupplementaryData1


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|+|Envlp|ISO20022.Canm002001.SupplementaryDataEnvelope1||XmlElement()||
|+|PlcAndNm|String||XmlElement()||
||Validation|Some(String)||XmlIgnore(), JsonIgnore()|validation(validElement(Envlp))|

---

## Value ISO20022.Canm002001.SupplementaryDataEnvelope1
...
## Value ISO20022.Canm002001.Traceability10
...
## Enum ISO20022.Canm002001.TypeOfAmount21Code
