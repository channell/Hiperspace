# setr.016.001.04-physical
```mermaid
classDiagram
    class ISO20022.Setr016001.Document {
        # Uri  : String
        + OrdrInstrStsRpt () : ISO20022.Setr016001.OrderInstructionStatusReportV04
        + Validation () = validation(validElement(OrdrInstrStsRpt))
    }
    class ISO20022.Setr016001.OrderInstructionStatusReportV04 {
        # owner  : ISO20022.Setr016001.Document
        + Xtnsn  : List~ISO20022.Setr016001.Extension1~
...
## EntityImpl ISO20022.Setr016001.Document
...
## AspectImpl ISO20022.Setr016001.OrderInstructionStatusReportV04


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|#|owner|ISO20022.Setr016001.Document||||
|+|Xtnsn|List<ISO20022.Setr016001.Extension1>||XmlElement()||
