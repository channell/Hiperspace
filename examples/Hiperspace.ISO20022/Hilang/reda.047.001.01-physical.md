# reda.047.001.01-physical
```mermaid
classDiagram
    class ISO20022.Reda047001.Document {
        # Uri  : String
        + SctyCSDLkStsAdvc () : ISO20022.Reda047001.SecurityCSDLinkStatusAdviceV01
        + Validation () = validation(validElement(SctyCSDLkStsAdvc))
    }
    class ISO20022.Reda047001.SecurityCSDLinkStatusAdviceV01 {
        # owner  : ISO20022.Reda047001.Document
        + SplmtryData  : List~ISO20022.Reda047001.SupplementaryData1~
        ...
        + Validation () = validation(validList("""SplmtryData""",SplmtryData),validElement(SplmtryData),validElement(SctyCSDLkId),validElement(SctyCSDLkSts),validElement(MsgHdr))
    }
```
...
## EntityImpl ISO20022.Reda047001.Document
...
## AspectImpl ISO20022.Reda047001.SecurityCSDLinkStatusAdviceV01


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|#|owner|ISO20022.Reda047001.Document||||
|+|SplmtryData|List<ISO20022.Reda047001.SupplementaryData1>||XmlElement()||
