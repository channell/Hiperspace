# canm.001.001.04-physical
```mermaid
classDiagram
    class ISO20022.Canm001001.Document {
        # Uri  : String
        + NtwkMgmtInitn () : ISO20022.Canm001001.NetworkManagementInitiationV04
        + Validation () = validation(validElement(NtwkMgmtInitn))
    }
    class ISO20022.Canm001001.NetworkManagementInitiationV04 {
        # owner  : ISO20022.Canm001001.Document
        + SctyTrlr  : ISO20022.Canm001001.ContentInformationType41
        + SplmtryData  : List~ISO20022.Canm001001.SupplementaryData1~
        + OrgnlRspnCd  : String
        + PrcgRslt  : ISO20022.Canm001001.ProcessingResult26
        + AddtlData  : List~ISO20022.Canm001001.AdditionalData2~
        + TxDesc  : String
        + Rcncltn  : ISO20022.Canm001001.Reconciliation4
        + AddtlFee  : List~ISO20022.Canm001001.AdditionalFee3~
...
## EntityImpl ISO20022.Canm001001.Document
...
## AspectImpl ISO20022.Canm001001.NetworkManagementInitiationV04
...
|+|SplmtryData|List<ISO20022.Canm001001.SupplementaryData1>||XmlElement()||
|+|OrgnlRspnCd|String||XmlElement()||
|+|PrcgRslt|ISO20022.Canm001001.ProcessingResult26||XmlElement()||
|+|AddtlData|List<ISO20022.Canm001001.AdditionalData2>||XmlElement()||
|+|TxDesc|String||XmlElement()||
|+|Rcncltn|ISO20022.Canm001001.Reconciliation4||XmlElement()||
|+|AddtlFee|List<ISO20022.Canm001001.AdditionalFee3>||XmlElement()||
