# sese.013.001.11-physical
```mermaid
classDiagram
    class ISO20022.Sese013001.Document {
        # Uri  : String
        + PrtflTrfConf () : ISO20022.Sese013001.PortfolioTransferConfirmationV11
        + Validation () = validation(validElement(PrtflTrfConf))
    }
    class ISO20022.Sese013001.PortfolioTransferConfirmationV11 {
        # owner  : ISO20022.Sese013001.Document
        + Xtnsn  : List~ISO20022.Sese013001.Extension1~
        + MktPrctcVrsn  : ISO20022.Sese013001.MarketPracticeVersion1
        + PdctTrf  : List~ISO20022.Sese013001.PortfolioTransfer10~
        ...
        + OthrCorpInvstr  : List~ISO20022.Sese013001.Organisation36~
        + ScndryCorpInvstr  : ISO20022.Sese013001.Organisation36
        + PmryCorpInvstr  : ISO20022.Sese013001.Organisation36
        + OthrIndvInvstr  : List~ISO20022.Sese013001.IndividualPerson8~
...
## EntityImpl ISO20022.Sese013001.Document
...
## AspectImpl ISO20022.Sese013001.PortfolioTransferConfirmationV11


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|#|owner|ISO20022.Sese013001.Document||||
|+|Xtnsn|List<ISO20022.Sese013001.Extension1>||XmlElement()||
|+|MktPrctcVrsn|ISO20022.Sese013001.MarketPracticeVersion1||XmlElement()||
|+|PdctTrf|List<ISO20022.Sese013001.PortfolioTransfer10>||XmlElement()||
...
|+|OthrCorpInvstr|List<ISO20022.Sese013001.Organisation36>||XmlElement()||
...
|+|OthrIndvInvstr|List<ISO20022.Sese013001.IndividualPerson8>||XmlElement()||
