# tsmt.015.001.03-physical
```mermaid
classDiagram
    class ISO20022.Tsmt015001.Document {
        # Uri  : String
        + DltaRpt () : ISO20022.Tsmt015001.DeltaReportV03
        + Validation () = validation(validElement(DltaRpt))
    }
    class ISO20022.Tsmt015001.DeltaReportV03 {
        # owner  : ISO20022.Tsmt015001.Document
        + ReqForActn  : ISO20022.Tsmt015001.PendingActivity2
        + UpdtdElmt  : List~ISO20022.Tsmt015001.ComparisonResult2~
        ...
        + UsrTxRef  : List~ISO20022.Tsmt015001.DocumentIdentification5~
...
## EntityImpl ISO20022.Tsmt015001.Document
...
## AspectImpl ISO20022.Tsmt015001.DeltaReportV03
...
|+|UpdtdElmt|List<ISO20022.Tsmt015001.ComparisonResult2>||XmlElement()||
...
|+|UsrTxRef|List<ISO20022.Tsmt015001.DocumentIdentification5>||XmlElement()||
