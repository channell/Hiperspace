...
classDiagram
    ...
    class ISO20022.Tsmt032001.Action2Code {
        CINR = 1
        ARRO = 2
        ARBA = 3
        SBDS = 4
    ...
    class ISO20022.Tsmt032001.BICIdentification1 {
        + BIC  : String
    }
    class ISO20022.Tsmt032001.BaselineStatus3Code {
        DARQ = 1
        SERQ = 2
        SCRQ = 3
        CLRQ = 4
    ...
    class ISO20022.Tsmt032001.DocumentIdentification3 {
        + Vrsn  : Decimal
        + Id  : String
    }
    class ISO20022.Tsmt032001.DocumentIdentification5 {
        + IdIssr  : ISO20022.Tsmt032001.BICIdentification1
        + Id  : String
    }
    ISO20022.Tsmt032001.DocumentIdentification5 *-- ISO20022.Tsmt032001.BICIdentification1
    class ISO20022.Tsmt032001.MessageIdentification1 {
        + CreDtTm  : DateTime
        + Id  : String
    }
    class ISO20022.Tsmt032001.PendingActivity2 {
        + Desc  : String
        + Tp  : String
    }
    class ISO20022.Tsmt032001.SimpleIdentificationInformation {
        + Id  : String
    }
    class ISO20022.Tsmt032001.StatusExtensionNotificationV03 {
        ...
        + UsrTxRef  : global::System.Collections.Generic.List~ISO20022.Tsmt032001.DocumentIdentification5~
    ...
    ISO20022.Tsmt032001.StatusExtensionNotificationV03 *-- ISO20022.Tsmt032001.PendingActivity2
    ISO20022.Tsmt032001.StatusExtensionNotificationV03 *-- ISO20022.Tsmt032001.TransactionStatus5
    ISO20022.Tsmt032001.StatusExtensionNotificationV03 *-- ISO20022.Tsmt032001.DocumentIdentification5
    ISO20022.Tsmt032001.StatusExtensionNotificationV03 *-- ISO20022.Tsmt032001.DocumentIdentification3
    ISO20022.Tsmt032001.StatusExtensionNotificationV03 *-- ISO20022.Tsmt032001.SimpleIdentificationInformation
    ISO20022.Tsmt032001.StatusExtensionNotificationV03 *-- ISO20022.Tsmt032001.MessageIdentification1
    class ISO20022.Tsmt032001.TransactionStatus5 {
        + Desc  : String
        + ChngDtTm  : DateTime
        + Sts  : String
    }
...
## Enum ISO20022.Tsmt032001.Action2Code
...
## Value ISO20022.Tsmt032001.BICIdentification1
...
## Enum ISO20022.Tsmt032001.BaselineStatus3Code
...
## Type ISO20022.Tsmt032001.Document
...
## Value ISO20022.Tsmt032001.DocumentIdentification3
...
## Value ISO20022.Tsmt032001.DocumentIdentification5


| |Name|Type|*|@|=|
|-|-|-|-|-|-|
|+|IdIssr|ISO20022.Tsmt032001.BICIdentification1||XmlElement()||
|+|Id|String||XmlElement()||
||Validation|Some(String)||XmlIgnore(), JsonIgnore()|validation(validElement(IdIssr))|

---

## Value ISO20022.Tsmt032001.MessageIdentification1
...
## Value ISO20022.Tsmt032001.PendingActivity2
...
## Value ISO20022.Tsmt032001.SimpleIdentificationInformation
...
## Aspect ISO20022.Tsmt032001.StatusExtensionNotificationV03
...
|+|UsrTxRef|global::System.Collections.Generic.List<ISO20022.Tsmt032001.DocumentIdentification5>||XmlElement()||
...
## Value ISO20022.Tsmt032001.TransactionStatus5
