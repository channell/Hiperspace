# tsrv.017.001.01-physical
```mermaid
classDiagram
    class ISO20022.Tsrv017001.Document {
        # Uri  : String
        + DmndWdrwlNtfctn () : ISO20022.Tsrv017001.DemandWithdrawalNotificationV01
        + Validation () = validation(validElement(DmndWdrwlNtfctn))
    }
    class ISO20022.Tsrv017001.DemandWithdrawalNotificationV01 {
        # owner  : ISO20022.Tsrv017001.Document
        + DgtlSgntr  : ISO20022.Tsrv017001.PartyAndSignature2
        + DmndWdrwlNtfctnDtls  : ISO20022.Tsrv017001.UndertakingDemandWithdrawal1
        + Validation () = validation(validElement(DgtlSgntr),validElement(DmndWdrwlNtfctnDtls))
    }
```
...
## EntityImpl ISO20022.Tsrv017001.Document
...
## AspectImpl ISO20022.Tsrv017001.DemandWithdrawalNotificationV01
