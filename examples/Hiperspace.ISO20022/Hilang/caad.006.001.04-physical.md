# caad.006.001.04-physical
```mermaid
classDiagram
    class ISO20022.Caad006001.Document {
        # Uri  : String
        + RcncltnRspn () : ISO20022.Caad006001.ReconciliationResponseV04
        + Validation () = validation(validElement(RcncltnRspn))
    }
    class ISO20022.Caad006001.ReconciliationResponseV04 {
        # owner  : ISO20022.Caad006001.Document
        + SctyTrlr  : ISO20022.Caad006001.ContentInformationType41
        + SplmtryData  : List~ISO20022.Caad006001.SupplementaryData1~
        + PrtctdData  : List~ISO20022.Caad006001.ProtectedData2~
        + OrgnlRspnCd  : String
        + PrcgRslt  : ISO20022.Caad006001.ProcessingResult23
        + AddtlData  : List~ISO20022.Caad006001.AdditionalData2~
        + Rcncltn  : ISO20022.Caad006001.Reconciliation4
        + AddtlFee  : List~ISO20022.Caad006001.AdditionalFee3~
        + SttlmSvc  : ISO20022.Caad006001.SettlementService6
        + Jursdctn  : ISO20022.Caad006001.Jurisdiction2
        + RcncltnTtls  : List~ISO20022.Caad006001.TransactionTotals14~
        + LifeCyclId  : String
        + RtrvlRefNb  : String
        + TrnsmssnDtTm  : DateTime
        + SysTracAudtNb  : String
        + Prgrmm  : List~ISO20022.Caad006001.ProgrammeMode5~
...
## EntityImpl ISO20022.Caad006001.Document
...
## AspectImpl ISO20022.Caad006001.ReconciliationResponseV04
...
|+|SplmtryData|List<ISO20022.Caad006001.SupplementaryData1>||XmlElement()||
|+|PrtctdData|List<ISO20022.Caad006001.ProtectedData2>||XmlElement()||
|+|OrgnlRspnCd|String||XmlElement()||
|+|PrcgRslt|ISO20022.Caad006001.ProcessingResult23||XmlElement()||
|+|AddtlData|List<ISO20022.Caad006001.AdditionalData2>||XmlElement()||
|+|Rcncltn|ISO20022.Caad006001.Reconciliation4||XmlElement()||
|+|AddtlFee|List<ISO20022.Caad006001.AdditionalFee3>||XmlElement()||
|+|SttlmSvc|ISO20022.Caad006001.SettlementService6||XmlElement()||
|+|Jursdctn|ISO20022.Caad006001.Jurisdiction2||XmlElement()||
|+|RcncltnTtls|List<ISO20022.Caad006001.TransactionTotals14>||XmlElement()||
|+|LifeCyclId|String||XmlElement()||
|+|RtrvlRefNb|String||XmlElement()||
|+|TrnsmssnDtTm|DateTime||XmlElement()||
|+|SysTracAudtNb|String||XmlElement()||
|+|Prgrmm|List<ISO20022.Caad006001.ProgrammeMode5>||XmlElement()||
