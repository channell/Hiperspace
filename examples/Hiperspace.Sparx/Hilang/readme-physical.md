...
classDiagram
    ...
    Sparx.PathMessage *-- Graph.Route
    Sparx.PathMessage *-- String
    Sparx.PathMessage *-- Graph.HiperEdge
    ...
    Sparx.EA.Operation o-- Sparx.EA.OperationParam
    Sparx.EA.Operation o-- Sparx.EA.OperationPostCondition
    Sparx.EA.Operation o-- Sparx.EA.OperationPreCondition
    Sparx.EA.Operation o-- Sparx.EA.OperationTag
    ...
    Sparx.EA.ObjectResource --> Sparx.EA.Resource
    ...
    Sparx.EA.DiagramObject --> Sparx.EA.Diagram
    Sparx.EA.DiagramObject --> Sparx.EA.Element
    ...
    Sparx.EA.DiagramLink --> Sparx.EA.Diagram
    Sparx.EA.DiagramLink --> Sparx.EA.Connector
    ...
    Sparx.EA.Diagram --> Sparx.EA.Package
    ...
    Sparx.EA.Connector --> Sparx.EA.Element
    Sparx.EA.Connector --> Sparx.EA.Element
    Sparx.EA.Connector o-- Sparx.EA.ConnectorConstraint
    Sparx.EA.Connector o-- Sparx.EA.ConnectorTag
    Sparx.EA.Connector o-- Sparx.EA.RoleConstraint
    ...
    Sparx.EA.Attribute --> Sparx.EA.Element
    Sparx.EA.Attribute *-- Sparx.EA.AttributeConstraint
    Sparx.EA.Attribute *-- Sparx.EA.AttributeTag
    ...
    Sparx.EA.Package o-- Sparx.EA.PackageLoaded
    ...
    Sparx.EA.Element --> Sparx.EA.Package
    Sparx.EA.Element --> Sparx.EA.Diagram
    Sparx.EA.Element *-- Sparx.EA.ObjectEffort
    Sparx.EA.Element *-- Sparx.EA.ObjectConstraint
    Sparx.EA.Element o-- Sparx.EA.ObjectFile
    Sparx.EA.Element o-- Sparx.EA.ObjectMetric
    Sparx.EA.Element o-- Sparx.EA.ObjectProblem
    Sparx.EA.Element o-- Sparx.EA.ObjectProperty
    Sparx.EA.Element o-- Sparx.EA.ObjectRequire
    Sparx.EA.Element o-- Sparx.EA.ObjectResource
    Sparx.EA.Element o-- Sparx.EA.ObjectRisk
    Sparx.EA.Element o-- Sparx.EA.ObjectScenario
    Sparx.EA.Element o-- Sparx.EA.ObjectTest
    Sparx.EA.Element o-- Sparx.EA.Operation
    Sparx.EA.Element o-- Sparx.EA.ElementLoaded
    class Sparx.EA.ElementLoaded {
        # owner  : Sparx.EA.Element
        + When  : DateTime
    }
    Sparx.EA.ElementLoaded ..|> Sparx.Load.Tracking
    class Sparx.EA.PackageLoaded {
        # owner  : Sparx.EA.Package
        + When  : DateTime
    }
    Sparx.EA.PackageLoaded ..|> Sparx.Load.Tracking
    class Index.Element {
        # Name  : String
