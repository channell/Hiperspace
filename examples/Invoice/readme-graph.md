...
classDiagram
    ...
    ERP.Location.Address ..|> Node
    ERP.Location.Address ..|> Edge
    ...
    ERP.Location.Store ..|> Node
    ERP.Location.Store ..|> Edge
    ...
    ERP.Finance.Tarriff ..|> Node
    ERP.Finance.Tarriff ..|> Edge
    ...
    ERP.Finance.Shipping ..|> Node
    ERP.Finance.Shipping ..|> Edge
    ...
    ERP.Client.Customer ..|> Node
    ERP.Client.Customer ..|> Edge
    ...
    ERP.Sales.Order ..|> Node
    ERP.Sales.Order ..|> Edge
    ...
    ERP.Sales.Invoice ..|> Node
    ERP.Sales.Invoice ..|> Edge
```
