...
classDiagram
    ...
    Access.RBAC.Group ..|> Node
    Access.RBAC.Group ..|> Edge
    ...
    Access.RBAC.User ..|> Node
    Access.RBAC.User ..|> Edge
    ...
    Access.RBAC.RolePermission ..|> Edge
    ...
    Access.RBAC.UserPermission ..|> Edge
    ...
    Access.RBAC.GroupPermission ..|> Edge
```
