...
namespace Hiperspace
{
        ...
        where TEntity : Element<TEntity>, new()
    {
        ...
        /// <summary>
        /// Get an entity using the key value, with an option to ignore any alternate source.
        /// </summary>
        /// <remarks> 
        /// the UseAlternate flag overided any default behavour such as fetching from a external database, or calculating a cube
        /// </remarks>
        /// <typeparam name="TKey"></typeparam>
        /// <param name="key"></param>
        /// <param name="useAlternate">Override any default behavior such as fetching from an external database, or calculating a cube</param>
        /// <returns>an entity</returns>
        public abstract TEntity? Get<TKey>(ref TKey key, bool useAlternate = true);
        /// <remarks>
        /// Will be replaced with abstract in a future release
        /// </remarks>
