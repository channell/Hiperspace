...
namespace Hiperspace.Meta
{
    ...
    public partial struct MapElement
    {
        ...
        internal MapElement(KeyType key, ValueType value) : this()
        {
            _key = key;
            _value = value;
        }
        internal MapElement(KeyType key) : this()
        {
            _key = key;
        }
        public MapElement(MapElement source) : this()
        {
            _key = source._key;
        ...
        [ProtoMember(2)]
        public List<Hiperspace.Meta.MapPair>? Map
        {
            get
            {
                return _value.Map;
        ...
        {
            internal KeyType(MapElement item)
            {
        ...
        public static explicit operator KeyType(MapElement item) => item._key;

        [ProtoContract]
        public struct ValueType
        {
            internal ValueType(MapElement item)
            {
            ...
            [ProtoMember(1)] public Int32? Element;
            [ProtoMember(2)] public List<Hiperspace.Meta.MapPair>? Map;
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void Bind(SubSpace space)
            {
        ...
        public static explicit operator ValueType(MapElement item) => item._value;
        ...
        #region Entity
        public Result<MapElement> Bind(SubSpace subSpace)
        {
        ...
        {
            if (other is null) return false;
            if (other is MapElement) return Equals((MapElement)other);
            return false;
        }
        ...
        public static bool operator ==(MapElement left, MapElement right)
        {
