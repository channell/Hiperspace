...
namespace Hiperspace
{
    ...
    {
        internal Predicate<TEntity> _predicate;
        ...
        {
            _predicate = (p, s, u, b) => entityOnlyPredicate(p);
        }
        ...
        {
            _predicate = (p, s, u, b) => entityContextReadPredicate(p, s, b);
        }
        /// <summary>
        ...
        {
            _predicate = entityContextReadUserPredicate;
        }
    }
}
